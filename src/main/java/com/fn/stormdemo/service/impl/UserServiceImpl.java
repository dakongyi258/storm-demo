package com.fn.stormdemo.service.impl;

import java.io.Serializable;
import java.util.List;

import com.fn.stormdemo.dao.UserDao;
import com.fn.stormdemo.pojo.User;
import com.fn.stormdemo.service.UserService;
...
//			flag=userDao.insertBatch(user);
            ...
            logger.info("user数据:{}", user.toString());
        } catch (Exception e) {
